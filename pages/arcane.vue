...
#module-text
  ...
  ModuleMainSection(title="Arcane" illustration="arcane" align="center")
    ModuleSubSection(subtitle="Getting started" align="center")
      ...
      ModuleBox(jack="in" to="arcane" :x="617/720" :y="426/760")
        :markdown-it
          To get started immediately, use the topmost **1/16** output to drive the clock input of a step sequencer.
      ModuleBox(jack="out" to="arcane" :x="475/720" :y="107/760")
        :markdown-it
          Then, send that sequencer's output to Arcane's quantizer input.
      ModuleBox(align="right" jack="in" to="arcane" :x="664/720" :y="107/760")
        :markdown-it
          Send the quantizer output to an oscillator, and listen what happens.
      ModuleBox
        :markdown-it
          Next, try other jacks as a clock!
    ...
    ModuleSubSection(subtitle="Inputs and Outputs")
      ...
      ModuleBox(jack="in" to="arcane" :x="570/720" :y="154/760")
        :markdown-it
          **Padded**: Like **Melody**, sends the entire 8 note pattern, with any repeated note being one octave higher than normal.
          If you combine them with [ML modules sequential switch 8 to 1](https://github.com/martin-lueders/ML_modules/wiki/Sequential-Switches), they can become a melody.
      ...
      ModuleBox(jack="in" to="arcane" :x="664/720" :y="426/760")
        :markdown-it
          **Gate/Ramp** on the **32nd note**, **16th note**, **8th note**, **4th note**, **Bar**: This row of outputs sends, depending on the position of the **Gate/Ramp** switch, either a gate synchronized to the BPM at the corresponding interval in 4/4 time, or a 0V-10V ramp corresponding to that phase.
  ...
  ModuleMainSection(title="Arcane" displaytitle="none" illustration="arcane" align="right")
